...
public class ProjectDataAction extends ActionSupport implements ModelDriven<CompanyModel> {
	...
	public String execute() {
		...
		System.out.println("from ProjectDataAction: projectid= " + projectid);
		
		ProjectDataService projectDataService = new ProjectDataService();
		Project project = projectDataService.getProjectData(projectid);
		
		System.out.println("from ProjectDataAction: Project Name = " + project.getName());
